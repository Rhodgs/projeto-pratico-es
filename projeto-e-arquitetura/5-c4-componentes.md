...
<div align="center">
  <img width="8192" height="4187" alt="componentesJV drawio" src="https://github.com/user-attachments/assets/d3ee9f5d-fe68-4d31-874b-9ac2fb16fbbc" />
  <br>
  <em>*Figura 1: Diagrama de Componentes (Nível 3) para a API de Backend do Jornada Verde*</em>
</div>
...
| :--- | :---: | :--- |
| **AuthMiddleware** | Component | Intercepta as requisições do aplicativo móvel, lê o token de acesso no Firebase Auth e identifica os privilégios do usuário (Aluno ou Professor). Desarrolhado em **Node.js / Express Middleware** |
...
| **Firebase Auth** | External System | Serviço de nuvem de terceiros responsável por garantir o login seguro e validar as credenciais de acesso |
