...
A camada de apresentação do sistema Jornada Verde é construída utilizando o framework Flutter, o que permite uma interface reativa e centrada na experiência do usuário. Esta camada é responsável por traduzir as intenções dos alunos e professores em ações dentro do sistema. No dashboard principal, o aluno visualiza o seu progresso através de uma barra de experiência e um card dinâmico que exibe a sua posição na comunidade, extraindo esses dados diretamente do serviço de ranking. 

Na central de aprendizagem, a interface organiza conteúdos educativos em formatos de cards interativos para vídeos e artigos, permitindo que o usuário filtre materiais por categorias específicas como reciclagem ou preservação da água. Para o corpo docente, a apresentação oferece um painel de controle administrativo onde é possível gerenciar turmas e monitorar métricas de desempenho coletivo através de indicadores visuais. 

Um ponto crucial desta camada é a gestão do perfil privado, onde o aluno encontra a sua vitrine de troféus. Neste espaço, ele satisfaz o seu desejo de visualizar as conquistas e selos acumulados, garantindo que essas recompensas sejam visíveis apenas para o próprio usuário. Todo o feedback visual, como os alertas de manutenção da sequência diária ou as celebrações de novos broches, ocorre de forma imediata por meio de componentes que reagem aos eventos processados pelo backend, mantendo o engajamento sem a necessidade de recarregar o aplicativo.

### Exemplos de Aplicação da camada de Negócio
Esta camada funciona como o cérebro do sistema, processando as regras de gamificação e validando se as ações do utilizador cumprem os requisitos para ganhar selos ou subir de nível. Ela gere a lógica da "ofensiva" diária e assegura que, embora o ranking seja público, a vitrine de broches permaneça privada. Além de validar quizzes e atividades, a camada de negócio é a origem dos eventos que alimentam o sistema, publicando atualizações no barramento de mensagens sempre que um objetivo é atingido. Isso permite que as regras pedagógicas evoluam sem afetar a interface ou o armazenamento de dados.
...
### 1. Publicação de Nova Atividade
...
### 3. Manutenção da "Ofensiva" (Engajamento Diário)
...
### 4. Divulgação de Novos Conteúdos Educativos
...
### 5. Atualização de Ranking e Comunidade
